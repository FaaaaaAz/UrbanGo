...
const conversacionMock = [
  ...
  },
  {
    ...
    hora: '17:02',
    esPropio: true, // Mensaje del pasajero
    remitente: 'Tú',
  },
  {
    id: 3,
...
const listaChats = [
  {
    ...
    rol: 'Conductor',
    ultimoMensaje: 'Ya llegué! Estoy al frente de la plaza',
    hora: '17:10',
    noLeidos: 0,
  },
];
        ...
        >
          ...
          <View style={styles.chatHeader}>
            ...
            <View style={styles.conductorInfo}>
              ...
              <View>
                <Text style={styles.conductorNombre}>Carlos Mendoza</Text>
                <Text style={styles.conductorRol}>Conductor</Text>
              </View>
            </View>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptySubtext}>Los mensajes con tus conductores aparecerán aquí</Text>
          </View>
        }
      />
    </SafeAreaView>
